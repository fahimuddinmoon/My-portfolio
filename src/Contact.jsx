        ...
        <div id="contact">
            ...
            <div className="lg:flex items-center gap-5 my-6 justify-evenly">
                ...
                <div className="border-2 border-blue-400 rounded-3xl text-center p-2 sm:p-4 mb-4 bg-white text-black">
                    <img className="mx-auto" src="../public/Image/icons8-email-96.png" alt="" />
                ...
                <div className="border-2 border-blue-400 rounded-3xl text-center p-2 sm:p-4 mb-4 bg-white text-black">
                    <img className="mx-auto" src="../public/Image/icons8-phone-contact-96.png" alt="" />
                ...
                <div className="border-2 border-blue-400 rounded-3xl text-center p-2 sm:p-4 mb-4 bg-white text-black">
                    <img className="mx-auto" src="../public/Image/icons8-whatsapp-96.png" alt="" />
